...
const DeleteCustomer = () => {
  ...
  const handleDelete = () => {
    ...
    axios.delete(`http://localhost:5001/customers/${id}`)
      .then(() => { setDeleting(false); navigate("/customers"); })
  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      ...
      <div className="ml-52 flex-1 p-8">
        <div className="mb-6">
          <h1 className="text-2xl font-bold text-gray-800">Delete Customer</h1>
        ...
        {loading ? <Spinner /> : customer ? (
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 max-w-lg p-8">
            <div className="flex flex-col items-center text-center mb-6">
              ...
              <p className="text-gray-500 text-sm">You are about to permanently delete this customer.</p>
            </div>
