...
const AccountPage = () => {
  ...
  const [customer] = useState(JSON.parse(localStorage.getItem("customer") || "null"));
  ...
  useEffect(() => {
    ...
    axios
      .get(`http://localhost:5002/orders/my/${customer.id}`)
      .then((res) => {
            ...
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
              ...
              {loading ? (
                ...
                <div className="text-center py-12">
                  ...
                  <Link to="/shop" className="text-orange-500 hover:underline text-sm mt-2 block">
                    Start Shopping
                  </Link>
                </div>
              ) : (
