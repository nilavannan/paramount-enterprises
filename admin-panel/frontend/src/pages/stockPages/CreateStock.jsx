...
const CreateStock = () => {
  ...
  const validate = () => {
    ...
    else if (Number(price) < 0)         e.price = "Cannot be negative";
    return e;
  };
  ...
  const handleSubmit = () => {
    ...
    setLoading(true);
    axios.post("http://localhost:5001/stocks", {
      product, supplier,
      ...
      .then(() => { setLoading(false); navigate("/stocks"); })
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 max-w-lg p-8">
          <div className="space-y-5">
            ...
            <div>
              ...
              <p className="text-gray-400 text-xs mt-1">Alert triggers when stock drops to this level</p>
            ...
            <div>
              ...
              <p className="text-gray-400 text-xs mt-1">Paste a direct image URL to show product photo in the shop</p>
            </div>
          </div>
