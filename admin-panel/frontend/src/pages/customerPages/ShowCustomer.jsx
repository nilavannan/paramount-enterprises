    ...
    <div className="flex min-h-screen bg-gray-50">
      ...
      <div className="ml-52 flex-1 p-8">
        <div className="mb-6">
          ...
          <p className="text-gray-500 text-sm mt-1">View customer information</p>
        </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 max-w-lg p-8">
            <div className="space-y-4">
              {[
                ...
                { label: "Registered", value: new Date(customer.createdAt).toLocaleString() },
              ].map((item) => (
            ...
            <div className="flex gap-3 mt-8">
              <Link to={`/customers/edit/${customer._id}`} className="flex-1 text-center bg-blue-900 text-white py-2.5 rounded-lg text-sm font-medium hover:bg-blue-800 transition-colors">Edit</Link>
              <Link to="/customers" className="flex-1 text-center bg-gray-100 text-gray-700 py-2.5 rounded-lg text-sm font-medium hover:bg-gray-200 transition-colors">Back</Link>
            </div>
          </div>
