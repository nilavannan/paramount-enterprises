        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 max-w-lg p-8">
          <div className="space-y-5">
            ...
            {[
              ...
              { label: "Email Address", value: email, set: setEmail, err: errors.email, key: "email" },
            ].map((f) => (
              <div key={f.label}>
                ...
                <input
                  ...
                  onChange={(e) => {
                    ...
                    if (f.key) setErrors({ ...errors, [f.key]: "" });
                  }}
                  className={inputClass(f.err)}
                />
                {f.err && (
                  <p className="text-red-500 text-xs mt-1.5">⚠ {f.err}</p>
                )}
              </div>
            ))}
